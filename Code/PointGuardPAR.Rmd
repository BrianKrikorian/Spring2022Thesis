...
pgTeamAdjustment<-mapply(teamAdjustment, minutesPlayed, points, teamTotalPoints)
...
PAR<-function(pgOffensiveAndDefensivePoints, pgTeamAdjustment, pgPointsPerWin)
+ {(pgOffensiveAndDefensivePoints*pgTeamAdjustment)/pgPointsPerWin}
pgPAR<-diag(diag(mapply(PAR, pgOffensiveAndDefensivePoints,pgTeamAdjustment,pgPointsPerWin)))
print('PAR Data')
print(pgPAR)
```
