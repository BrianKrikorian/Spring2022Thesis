...
plot(league$VORP, scaledPAR, xlab = "VORP", ylab = "PAR", main = "Value Over Replacement Player vs. Points Above Replacement")
plot(league$WS, scaledPAR,  xlab = "WS", ylab = "PAR", main = "Win Shares vs. Points Above Replacement")
plot(league$BPM, scaledPAR, xlab = "BPM", ylab = "PAR", main = "Box Plus Minus vs. Points Above Replacement")
plot(league$PER, scaledPAR, xlab = "PER", ylab = "PAR", main = "Player Efficiency Rating vs. Points Above Replacement")
```
